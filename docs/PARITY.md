...
compares complete OpenAI-compatible request sequences after workspace-only normalization,
including
...
canonical tool-argument serialization. Concurrency, authenticated startup, and
