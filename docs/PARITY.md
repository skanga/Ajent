...
therefore executable-proven; queued/attachment composer behavior, thread
switching, resize, and append-only scrollback remain in the terminal
...
remaining picker backlog is limited to selecting and switching threads.
