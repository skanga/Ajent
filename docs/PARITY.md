...
continuation, and final stop reason. It also compares both complete upstream
OpenAI-compatible request bodies after workspace-only normalization, including
...
canonical tool-argument serialization. Cancellation,
