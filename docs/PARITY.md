...
two-row shortcut inventory and six-row composer cell-for-cell. This also
identified separate wide-only widget backlog: the pinned executable adds a
bordered first-run starter panel and richer throughput/status density at 96
columns. Resize signaling and core reflow are executable-proven.
