...
callback, and compares all three upstream requests. The gate compares complete
OpenAI-compatible request sequences after workspace-only normalization,
including
...
canonical tool-argument serialization. Cancellation, concurrency,
authenticated startup, and
