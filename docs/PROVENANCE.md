...
| Subprocess byte-idle watchdog, bounded capture, shell output spill, error extraction, and preview envelope | `mcp-cpp/include/mcp/tools/util/subprocess.hpp`, `mcp-cpp/src/tools/util/subprocess.cpp`, `mcp-cpp/src/tools/shell.cpp` |
